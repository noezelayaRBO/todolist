...
<div class="container">
    <form class="row g-3" style="padding-top: 30px" action="/update" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-2"></div>
            <div class="col-md-10">
                <button type="submit" class="btn btn-dark" style="margin-top: 50px;">Update</button>
            </div>
        </div>
    </form>
</div>
